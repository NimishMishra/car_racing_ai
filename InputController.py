# No point in re-inventing the wheel. I found a beautiful script controlling 
# Direct Inputs to the game at https://github.com/wassgha/pygta-mac/blob/master/directkeys.py
